...
const App = (() => {
  ...
  function updatePotionButtons() {
    ...
    const effectMap = { mana: 'shuffle', frost: 'time', fire: 'bomb', arcane: 'rainbow' };
    potions.forEach(pot => {
  ...
  function handleLevelComplete(state) {
    ...
    document.getElementById('nextLevelBtn').onclick = () => { hideModal('completeModal'); startGameLevel(globalIdx + 1); };
  }
